...
const Footer = () => {
  return (
    <div className='h-[10vh] bottom-0 bg-black-700 flex gap-4 pt-4 justify-between relative my-3 max-md:mb-6 max-md:w-full items-center max-md:mt-10 border-t border-gray-300 max-sm:flex-col max-sm:pb-7'>
