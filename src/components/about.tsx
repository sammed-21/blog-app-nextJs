...
const AboutPage: React.FC = () => {
  ...
  return (
    ...
    <motion.section
      ref={ref}
      id="about"
      className="flex flex-col justify-center  gap-8 mt-7 items-center scroll-mt-30"
    >
      {/* Hero section */}
      ...
      >
        ...
        <p className="mb-3">
          I hold a degree in{" "}
          <span className="font-medium">Computer Science</span>. I expanded my
          skills through a coding bootcamp, specializing in{" "}
          <span className="font-medium">full-stack web development</span>.{" "}
          <span className="italic">
            What truly captivates me in programming
          </span>{" "}
          is the challenge-solving facet. The exhilaration of finally unlocking
          a solution is a sentiment I deeply cherish. My expertise centers
          around{" "}
          <span className="font-medium">
            React, Next.js, Tailwind CSS, Node.js, MongoDB, and Blockchain
          </span>
          . Im also well-acquainted with TypeScript. My enthusiasm for adopting
          fresh technologies is unceasing. Currently, I&#8217;m actively seeking
          a{" "}
