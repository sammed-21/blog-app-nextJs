...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="relative max-w-screen min-h-[80vh] flex justify-center items-center px-6 max-md:flex-col-reverse overflow-hidden max-sm:items-center   ">
        <div className="flex-1   justify-cetner flex gap-[50px]  flex-col">
          <h1 className="text-7xl font-semibold text-transparent bg-gradient-to-b from-blue-500 to-gray-400 bg-clip-text ">
